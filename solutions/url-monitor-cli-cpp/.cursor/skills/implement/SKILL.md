---
name: implement
description: Executes the implementation plan phase by phase with verification checkpoints. Use when running the QRSPI Implement phase with plan.md, or when the user invokes /implement.
