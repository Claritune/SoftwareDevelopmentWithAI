---
name: pr
description: Creates a pull request with context from the design discussion and actual diff. Use when opening a PR after QRSPI implementation, or when the user invokes /pr with a thoughts/qrspi/<id>/ artifact directory.
