...
- **Memory management** -- Does the design use modern C++ idioms (smart pointers, RAII, value semantics)? Or is it falling back to raw pointers and manual memory management?
...
- **Dependencies** -- Are the chosen third-party libraries appropriate? Is the dependency management strategy (vcpkg, Conan, FetchContent, vendoring) clear?
