...
2. **For each phase in `structure.md`**, expand into full implementation detail:
   ...
   - Code snippets for non-trivial changes (new methods, type definitions, class declarations)
...
- Use the project's existing test/lint/build commands for verification. Check CLAUDE.md, Makefile, or .csproj files for the right commands.
