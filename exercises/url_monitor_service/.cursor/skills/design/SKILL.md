---
name: design
description: Creates a design document aligning current state with desired end state before detailed planning. Use when running the QRSPI Design phase with task.md, questions.md, and research.md (brownfield) or task.md, questions.md, and answers.md (greenfield), or when the user invokes /design.
model: opus
