---
name: worktree
description: Creates an isolated git worktree for QRSPI implementation on a dedicated branch. Use when setting up an isolated branch before implement, or when the user invokes /worktree with a thoughts/qrspi/<id>/ artifact directory.
